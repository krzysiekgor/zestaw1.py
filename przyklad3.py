...
df = pd.read_csv('https://raw.githubusercontent.com/jizhang/pandas-tidy-data/master/data/pew.csv')
print(df)
...
df.head(10)
df = pd.read_csv('https://raw.githubusercontent.com/jizhang/pandas-tidy-data/master/data/billboard.csv')
...
df.to_csv('billboard-intermediate.csv', index=False)
df.head(10)
df = pd.read_csv('https://raw.githubusercontent.com/jizhang/pandas-tidy-data/master/data/tb.csv')
...
df.to_csv('tb-tidy.csv', index=False)
df.head(10)
df = pd.read_csv('https://raw.githubusercontent.com/jizhang/pandas-tidy-data/master/data/weather.csv')
...
df = df.reset_index()
df.to_csv('weather-tidy.csv', index=False)
df
df = pd.read_csv('https://raw.githubusercontent.com/jizhang/pandas-tidy-data/master/data/billboard-intermediate.csv')
...
df.to_csv('billboard-rank.csv', index=False)
print(df_track, '\n\n', df)